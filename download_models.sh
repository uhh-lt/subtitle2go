...
wget http://ltdata1.informatik.uni-hamburg.de/kaldi_tuda_de/de_772k_G.carpa.bz2
wget http://ltdata1.informatik.uni-hamburg.de/kaldi_tuda_de/de_772k_rnnlm_lstm_2x.tar.bz2
